MAAM,QAAQ,GAAG,MAAM,CAAC,MAAM,CAAC,QAAQ,CAAC,iBAAiB,CAAC,CAAC,KAAK,CAAA;IAEhE,QAAQ,CAAC,KAAK,CAAC,yBAAyB,CAAC,CAAC,MAAM,CAAC,aAAa,CAAC,CAAC,cAAc,GAAC,UAAS,SAAS,EAAC,YAAY,EAAC,SAAS,EAAC,YAAY,EAAC,UAAU,EAAC,QAAQ;QACrJ,OAAO,CAAC,GAAG,CAAC,iBAAiB,CAAC,CAAC;QAC/B,MAAM,eAAe,GAAG,SAAS,CAAC,QAAQ,EAAE,CAAC;QAC7C,MAAM,kBAAkB,GAAG,YAAY,CAAC,QAAQ,EAAE,CAAC;QAEnD,IAAI,kBAAkB,GAAG,SAAS,CAAC;QACnC,IAAI,qBAAqB,GAAG,YAAY,CAAC;QAEzC,IAAI,eAAe,KAAK,MAAM,EAAE;YAC5B,MAAM,OAAO,GAAG,aAAa,CAAC,eAAe,CAAC,CAAC;YAC/C,IAAI,OAAO,KAAK,eAAe,EAAE;gBAC7B,kBAAkB,GAAG,MAAM,CAAC,MAAM,CAAC,OAAO,CAAC,CAAC;aAC/C;SACJ;QAED,IAAI,kBAAkB,KAAK,MAAM,EAAE;YAC/B,MAAM,OAAO,GAAG,aAAa,CAAC,kBAAkB,CAAC,CAAC;YAClD,IAAI,OAAO,KAAK,kBAAkB,EAAE;gBAChC,qBAAqB,GAAG,MAAM,CAAC,MAAM,CAAC,OAAO,CAAC,CAAC;aAClD;SACJ;QACD,MAAM,GAAG,GAAG,IAAI,CAAC,MAAM,CAAC,aAAa,CAAC,CAAC,MAAM,CAAC,kBAAkB,EAAE,qBAAqB,EAAE,SAAS,EAAE,YAAY,EAAE,UAAU,EAAE,QAAQ,CAAC,CAAA;QACvI,OAAO,GAAG,CAAC;IACf,CAAC,CAAC;AACN,CAAC,CAAC,CAAA;AAEF,SAAS,aAAa,CAAC,YAAoB;IACvC,MAAM,eAAe,GAAG,YAAY,CAAC,OAAO,CAAC,QAAQ,EAAE,EAAE,CAAC,CAAC,OAAO,CAAC,QAAQ,EAAE,EAAE,CAAC,CAAC;IACjF,MAAM,cAAc,GAAG,cAAc,CAAC,eAAe,CAAC,CAAC;IAEvD,IAAI,cAAc,EAAE;QAChB,OAAO,cAAc,CAAC;KACzB;SACI;QACD,OAAO,eAAe,CAAC;KAC1B;AACL,CAAC"}
✄
import "frida-il2cpp-bridge";
let translationMap = {};
function readFileStably(path) {
    try {
        const fd = new NativeFunction(Module.findExportByName(null, "open"), 'int', ['pointer', 'int'])(Memory.allocUtf8String(path), 0o0000000);
        if (fd < 0)
            return null;
        const fstat = new NativeFunction(Module.findExportByName(null, "fstat"), 'int', ['int', 'pointer']);
        const stat = Memory.alloc(144);
        fstat(fd, stat);
        const size = stat.add(48).readU32();
        const buf = Memory.alloc(size);
        const read = new NativeFunction(Module.findExportByName(null, "read"), 'ssize_t', ['int', 'pointer', 'size_t'])(fd, buf, size);
        new NativeFunction(Module.findExportByName(null, "close"), 'int', ['int'])(fd);
